    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 23, Name = "LED Bureaulamp", Description = "Dimbare bureaulamp met USB", Price = 49.99m, Stock = 25, CategoryId = 5, ImageUrl = "https://images.unsplash.com/photo-1565636192335-cd31679ba5f0?w=300&h=200&fit=crop" },
                ...
                new Product { Id = 32, Name = "Pop met Accessoires", Description = "Fashion pop met 20 kledingsets", Price = 49.99m, Stock = 35, CategoryId = 6, ImageUrl = "https://images.unsplash.com/photo-1603362306690-2b3e9ba2b60a?w=300&h=200&fit=crop" },
                new Product { Id = 33, Name = "Puzzel 1000 Stukjes", Description = "Natuurlandschap puzzel voor volwassenen", Price = 24.99m, Stock = 40, CategoryId = 6, ImageUrl = "https://images.unsplash.com/photo-1494059980473-813e73ee784b?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1169" }
            );
        }
    }
}