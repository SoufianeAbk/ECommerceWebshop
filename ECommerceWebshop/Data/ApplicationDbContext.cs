    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 32, Name = "Pop met Accessoires", Description = "Fashion pop met 20 kledingsets", Price = 49.99m, Stock = 35, CategoryId = 6, ImageUrl = "https://images.unsplash.com/photo-1603362305486-75a25f73051a?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1074" },
